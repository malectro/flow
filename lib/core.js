...
declare class Iterator<+Yield,+Return=void,-Next=void> implements $Iterator<Yield,Return,Next>, $Iterable<Yield,Return,Next>, Generator<Yield,Return,Next> {
  static from<+Yield,+Return,-Next>(iter: $Iterable<Yield,Return,Next>): Iterator<Yield,Return,Next>;
  static from<+Yield,+Return,-Next>(iter: $Iterator<Yield,Return,Next>): Iterator<Yield,Return,Next>;
  @@iterator(): Iterator<Yield,Return,Next>;
  next(value?: Next): IteratorResult<Yield,Return>;
  return<R>(value: R): IteratorResult<Yield,R|Return>;
  throw(error?: any): IteratorResult<Yield,Return>;
  map<U>(callbackfn: (value: Yield) => U): Iterator<U>;
  filter(callbackfn: typeof Boolean): Iterator<$NonMaybeType<Yield>>;
  filter(callbackfn: (value: Yield) => mixed): Iterator<Yield>;
  take(limit: number): Iterator<Yield>;
  drop(limit: number): Iterator<Yield>;
  asIndexedPairs(): Iterator<[number, Yield]>;
  flatMap<U>(callbackfn: (value: Yield) => Iterable<U>): Iterator<U>;
  reduce(callbackfn: (previousValue: Yield, value: Yield) => Yield): Yield;
  reduce<U>(callbackfn: (previousValue: U, value: Yield) => U, initialValue: U): U;
  toArray(): Array<Yield>;
  forEach(callbackfn: (value: Yield) => mixed): void;
  some(callbackfn: (value: Yield) => mixed): boolean;
  every(callbackfn: (value: Yield) => mixed): boolean;
  find(callbackfn: (value: Yield) => mixed): ?Yield;
...
type IteratorInterface<+T> = $Iterator<T,void,void>;
...
declare class AsyncIterator<+Yield,+Return=void,-Next=void> implements $AsyncIterator<Yield,Return,Next>, $AsyncIterable<Yield,Return,Next>, AsyncGenerator<Yield,Return,Next> {
  static from<+Yield,+Return,-Next>(iter: $AsyncIterable<Yield,Return,Next>): AsyncIterator<Yield,Return,Next>;
  static from<+Yield,+Return,-Next>(iter: $AsyncIterator<Yield,Return,Next>): AsyncIterator<Yield,Return,Next>;
  static from<+Yield,+Return,-Next>(iter: $Iterable<Yield,Return,Next>): AsyncIterator<Yield,Return,Next>;
  static from<+Yield,+Return,-Next>(iter: $Iterator<Yield,Return,Next>): AsyncIterator<Yield,Return,Next>;
  ...
  map<U>(callbackfn: (value: Yield) => U): AsyncIterator<U>;
  filter(callbackfn: typeof Boolean): AsyncIterator<$NonMaybeType<Yield>>;
  filter(callbackfn: (value: Yield) => mixed): AsyncIterator<Yield>;
  take(limit: number): AsyncIterator<Yield>;
  drop(limit: number): AsyncIterator<Yield>;
  asIndexedPairs(): AsyncIterator<[number, Yield]>;
  flatMap<U>(callbackfn: (value: Yield) => AsyncIterable<U>): AsyncIterator<U>;
  reduce(callbackfn: (previousValue: Yield, value: Yield) => Yield): Promise<Yield>;
  reduce<U>(callbackfn: (previousValue: U, value: Yield) => U, initialValue: U): Promise<U>;
  toArray(): Promise<Array<Yield>>;
  forEach(callbackfn: (value: Yield) => mixed): Promise<void>;
  some(callbackfn: (value: Yield) => mixed): Promise<boolean>;
  every(callbackfn: (value: Yield) => mixed): Promise<boolean>;
  find(callbackfn: (value: Yield) => mixed): Promise<?Yield>;
  +[key: $SymbolToStringTag]: (...any) => any;
}
...
type AsyncIteratorIterface<+T> = $AsyncIterator<T,void,void>;
